...
representative inputs can matter more than raw matrix reconstruction error.
...
for cost comparisons, and docs/wiki pages that describe the current boundary of
truth.
...
\begin{enumerate}
  ...
  tests, demos, benchmark artifacts, or clearly labeled future work;
