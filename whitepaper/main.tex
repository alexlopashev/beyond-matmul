...
Current confidence values are heuristic probe scores rather than calibrated
probabilities. When representative sample inputs are available, recovered
executable candidates record output-relative error on those samples and cap
confidence by that validation evidence, while dense GEMM remains the exact
fallback.
