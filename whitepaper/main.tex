...
and negative capture cases, demos for workload narratives, benchmark artifacts
for cost comparisons, an approximation-error ablation artifact, and docs/wiki
pages that describe the current boundary of truth. The support material includes
a concise evidence matrix in \texttt{docs/evidence\_matrix.md} that maps major
claims to tests, demos, benchmark artifacts, or future-work boundaries.
...
\begin{itemize}
  \item Conv/linear lowering from a CNN-style block;
